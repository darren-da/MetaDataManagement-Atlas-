...
public class CommondController {
   ...
   /* *//**
    ...
    public String publishApi(@PathVariable("id") String id, @RequestBody PublishApiModel publishApiModel){
        return commandService.publishApi(id,publishApiModel);
    }
    ...
    public String resetApiStatusByCodeList(@RequestBody List<String> codes){
        return commandService.resetApiStatusByCodeList(codes);
    }
