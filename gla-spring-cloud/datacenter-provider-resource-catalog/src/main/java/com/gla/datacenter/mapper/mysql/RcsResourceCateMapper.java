...
public interface RcsResourceCateMapper {
    ...
    List<Map<String, Object>> getGrandsonResourceByCode(@Param("code") String code);
    ...
    List<Map<String,String>> getResourceNameByCodeList(@Param("pCodeList") List<String> pCodeList);
}